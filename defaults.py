...
SUCCESSFUL_DOWNLOAD_FILE_MSG = ("Successfully downloaded file:"
                                " `{file_name}`")
SUCCESSFUL_DOWNLOAD_DIR_MSG = ("Successfully downloaded directory:"
                               " `{dir_name}`")
SUCCESSFUL_UPLOAD_FILE_MSG = ("Successfully uploaded file:"
                              " `{file_name}`")
SUCCESSFUL_UPLOAD_DIR_MSG = ("Successfully uploaded directory:"
                             " `{dir_name}`")
SUCCESSFUL_DELETE_FILE_MSG = ("Successfully deleted file:"
                              " `{file_name}`")
SUCCESSFUL_DELETE_DIR_MSG = ("Successfully deleted directory:"
                             " `{dir_name}`")
SUCCESSFUL_FILE_TRASH_MSG = ("Successfully moved file:"
                             " `{file_name}` to the trash")
SUCCESSFUL_DIR_TRASH_MSG = ("Successfully moved directory:"
...
DOWNLOADING_DIR_AS_ZIP_MSG = ("Downloading directory: `{dir_name}`"
                              " as `{file_name}`...")
