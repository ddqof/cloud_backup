...
class RemoteStorage:
    ...
    def single_request_upload(self, storage, filename, file_size, directory, zip=False):
        headers = {
        ...
        resumable_url = r.headers['location']
        r = requests.put(resumable_url, data=open(directory, 'rb'), headers=headers)
